...
export function Room(props) {
  ...
  // Memoize materials so they are only created once, not on every render
  ...
  // Emissive material to fake bloom glow without the expensive EffectComposer
  ...
  return (
    <group {...props} dispose={null}>
      {/* Removed EffectComposer + SelectiveBloom — replaced with emissive material on screens */}
      <mesh
